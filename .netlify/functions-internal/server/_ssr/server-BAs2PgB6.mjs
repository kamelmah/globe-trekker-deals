...
import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver-CCME8x-R.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BIc8ggWq.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-vlqe849l.mjs"),
		import("./start-CdYSYL58.mjs"),
