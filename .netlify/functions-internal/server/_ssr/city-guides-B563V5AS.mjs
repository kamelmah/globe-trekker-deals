...
//#region node_modules/.nitro/vite/services/ssr/assets/city-guides-B563V5AS.js
var city_guides_exports = /* @__PURE__ */ __exportAll({
	CITY_GUIDES: () => CITY_GUIDES,
	getCityGuide: () => getCityGuide,
	getCityGuideForRoute: () => getCityGuideForRoute,
	guideForRoutePage: () => guideForRoutePage
});
var CITY_GUIDES = [
	{
		slug: "marrakech",
		...
		description: "Guide Marrakech : meilleure période, quartiers à voir, budget sur place, transports, monnaie et formalités pour les Français. Tout pour préparer votre voyage.",
		intro: "Marrakech se visite très bien en trois ou quatre jours, à condition de savoir où loger et à quelle période venir. Voici les informations concrètes à connaître avant de réserver : climat mois par mois, quartiers, budget réel sur place et déplacements.",
		readingMinutes: 7,
		updated: "2026-08-30",
		practical: {
		...
		sections: [
			...
			},
			{
				...
				paragraphs: ["Trois nuits suffisent pour la médina, les jardins et une soirée à Jemaa el-Fna. Cinq nuits permettent d'ajouter une excursion dans l'Atlas, la cascade d'Ouzoud ou une journée à Essaouira sur la côte.", "Au-delà d'une semaine, Marrakech devient une base pour un circuit plus large : désert d'Agafay, vallée du Draa ou Merzouga. Dans ce cas, réservez le vol retour avec un peu de marge : les retours de désert sont souvent plus longs que prévu."]
			}
		]
	},
	{
		...
		description: "Guide Bangkok : quand partir, quartiers où loger, budget quotidien, métro et bateaux, monnaie, visa et conseils pratiques pour les voyageurs français.",
		intro: "Bangkok se traverse plus vite qu'on ne le croit si l'on comprend son réseau de BTS, de métro et de bateaux. Voici ce qu'il faut savoir avant d'y atterrir : saison, quartiers, budget réel et formalités.",
		readingMinutes: 8,
		updated: "2026-08-30",
		practical: {
		...
		sections: [
			...
			{
				heading: "Combien de temps rester ?",
				paragraphs: ["Trois jours pleins couvrent les temples, un marché, une balade en bateau et une soirée en rooftop. Cinq jours permettent d'ajouter Ayutthaya, le marché flottant de Damnoen Saduak ou une journée dédiée aux musées et au shopping.", "Beaucoup de voyageurs utilisent Bangkok comme point d'entrée avant de rejoindre le sud ou Chiang Mai : dans ce cas, gardez au moins deux nuits sur place en début de séjour pour absorber le décalage horaire (5 heures en été, 6 en hiver)."]
			}
		]
	},
	{
		...
		description: "Guide New York : meilleure période, quartiers de Manhattan et Brooklyn, budget réel, métro, ESTA et conseils pratiques pour préparer votre voyage depuis la France.",
		intro: "New York se prépare surtout côté budget et formalités : l'ESTA est obligatoire, la ville est chère, mais un séjour bien organisé reste tout à fait accessible. Voici les repères concrets.",
		readingMinutes: 8,
		updated: "2026-08-30",
		practical: {
		...
		sections: [
			...
			{
				heading: "Combien de temps rester ?",
				paragraphs: ["Quatre jours pleins constituent le minimum réaliste : un jour à Midtown, un au sud de Manhattan, un à Brooklyn, un pour les musées et Central Park. Une semaine permet d'ajouter Harlem, le Queens et un match ou un spectacle à Broadway.", "Comme le vol dure environ 8 heures à l'aller, évitez les séjours de moins de trois nuits : le rapport temps de vol / temps sur place devient défavorable."]
			}
		]
	},
	{
		...
		description: "Guide Lisbonne : quand partir, quartiers Alfama, Baixa et Belém, budget sur place, tramways et métro, conseils pratiques pour un week-end ou une semaine.",
		intro: "Lisbonne est l'une des capitales européennes les plus faciles à visiter en trois ou quatre jours, à condition d'accepter ses collines. Climat, quartiers, budget et transports : voici l'essentiel.",
		readingMinutes: 7,
		updated: "2026-08-30",
		practical: {
		...
		sections: [
			...
			{
				heading: "Combien de temps rester ?",
				paragraphs: ["Trois nuits couvrent confortablement Alfama, Baixa, Belém et une soirée fado. Quatre à cinq nuits permettent d'ajouter Sintra et ses palais, la plage de Cascais ou une journée à Setúbal.", "Pour un simple week-end, privilégiez un vol du vendredi soir et un retour le lundi matin : la liaison est courte (2 h 30) et le décalage horaire d'une heure seulement."]
			}
		]
	},
	{
		...
		description: "Guide Barcelone : meilleure période, quartiers Gothique, Eixample et Gràcia, budget quotidien, métro, réservations Sagrada Familia et conseils pratiques.",
		intro: "Barcelone se visite bien toute l'année, mais deux détails changent tout : réserver les sites de Gaudí à l'avance et choisir le bon quartier où dormir. Voici les repères concrets avant de partir.",
		readingMinutes: 7,
		updated: "2026-08-30",
		practical: {
		...
		sections: [
			...
			{
				heading: "Combien de temps rester ?",
				paragraphs: ["Trois nuits suffisent pour Gaudí, le quartier gothique et une soirée de tapas. Quatre à cinq nuits permettent d'ajouter Montjuïc, une plage et une excursion à Montserrat ou Sitges.", "Le vol depuis Paris dure environ 1 h 50 : c'est l'une des rares grandes villes européennes où un week-end de deux nuits reste vraiment rentable."]
			}
		]
	},
	{
		...
		description: "Guide Istanbul : meilleure période, quartiers où loger, budget sur place, transports, monnaie et formalités pour les Français. Tout pour préparer votre séjour.",
		intro: "Istanbul se visite bien en quatre jours si l'on accepte de ne pas tout voir. La ville est immense, coupée en deux par le Bosphore, et le choix du quartier où dormir change complètement l'expérience. Voici les informations concrètes à connaître avant de réserver votre vol.",
		readingMinutes: 8,
		updated: "2026-08-30",
		practical: {
		...
		sections: [
			...
			{
				heading: "Combien de temps rester ?",
				paragraphs: ["Trois nuits couvrent Sultanahmet, Beyoğlu et une traversée en ferry. Quatre à cinq nuits permettent d'ajouter Balat, Kadıköy, un hammam historique et une journée aux îles aux Princes, à une heure de bateau du centre.", "Au-delà d'une semaine, Istanbul devient une base pour un circuit turc plus large : Cappadoce en vol intérieur d'une heure, Éphèse ou Bursa en bus. Dans ce cas, gardez une nuit tampon avant le vol retour, les correspondances intérieures accusent souvent du retard."]
			}
		]
	},
	{
		...
		description: "Guide Dubaï : quand partir, quartiers où loger, budget réel sur place, métro et taxis, monnaie, visa et conseils pratiques pour les voyageurs français.",
		intro: "Dubaï se visite très différemment selon la saison et le quartier choisi. Entre la vieille ville de Deira, la Marina et le désert, les distances sont longues : mieux vaut planifier. Voici l'essentiel avant de réserver votre vol.",
		readingMinutes: 8,
		updated: "2026-08-30",
		practical: {
		...
		sections: [
			...
			{
				heading: "Combien de temps rester ?",
				paragraphs: ["Quatre nuits suffisent pour Downtown, la Marina, la vieille ville et une soirée dans le désert. Une semaine permet d'ajouter Abu Dhabi et la mosquée Cheikh Zayed en excursion, ainsi que quelques journées de plage.", "Dubaï fonctionne aussi très bien comme escale de deux ou trois nuits sur un trajet vers l'Asie ou l'océan Indien : les vols avec stopover sont souvent moins chers qu'un vol direct, et l'aéroport est l'un des mieux connectés du monde."]
			}
		]
	},
	{
		...
		description: "Guide Tokyo : meilleure saison, quartiers où loger, budget quotidien, métro et JR, monnaie, formalités et conseils pratiques pour un premier voyage au Japon.",
		intro: "Tokyo n'a pas de centre unique : la ville s'organise autour d'une dizaine de pôles reliés par la ligne Yamanote. Comprendre cette géographie évite de perdre des heures dans les transports. Voici l'essentiel avant de réserver.",
		readingMinutes: 9,
		updated: "2026-08-30",
		practical: {
		...
		sections: [
			...
			{
				heading: "Combien de temps rester ?",
				paragraphs: ["Quatre à cinq nuits sont un minimum pour Tokyo seule, compte tenu du décalage horaire de sept à huit heures et de la taille de la ville. Prévoyez des journées thématiques par quartier plutôt que des allers-retours.", "Dix à quatorze jours permettent d'ajouter Kyoto, Osaka et une étape nature comme Hakone, Nikkō ou Kanazawa, en Shinkansen. Dans ce cas, calculez la rentabilité du JR Pass avant d'acheter : au tarif actuel, deux allers-retours longue distance sont souvent nécessaires pour l'amortir."]
			}
		]
	},
	{
		...
		description: "Guide Alger : meilleure période, quartiers à visiter, budget sur place, transports, monnaie, visa pour les Français et conseils pratiques avant de partir.",
		intro: "Alger la Blanche se découvre à pied, entre les arcades du front de mer, la Casbah et les hauteurs de Notre-Dame d'Afrique. C'est une destination encore peu touristique, ce qui suppose un peu de préparation, notamment côté visa et argent liquide.",
		readingMinutes: 8,
		updated: "2026-08-30",
		practical: {
		...
		sections: [
			...
			{
				heading: "Combien de temps rester ?",
				paragraphs: ["Trois nuits permettent de couvrir la Casbah, le centre, le Jardin d'Essai et Notre-Dame d'Afrique sans se presser. Quatre à cinq nuits ajoutent Tipaza et ses ruines romaines en bord de mer, à une heure à l'ouest, ainsi que les plages de la côte turquoise.", "Pour un séjour plus long, Alger sert de porte d'entrée vers Constantine, Oran ou le Sahara (Ghardaïa, Timimoun), accessibles en vols intérieurs peu coûteux mais à réserver tôt en été."]
			}
		]
	},
	{
		...
		description: "Guide Rome : quand partir, quartiers où loger, budget sur place, transports, réservations des sites majeurs et conseils pratiques pour un city-break réussi.",
		intro: "Rome se marche : la plupart des sites du centre historique tiennent dans un périmètre de trois kilomètres. Le vrai enjeu d'un séjour réussi, ce sont les réservations et le choix de la saison. Voici les repères concrets avant de réserver votre vol.",
		readingMinutes: 8,
		updated: "2026-08-30",
		practical: {
		...
		sections: [
			...
			{
				heading: "Combien de temps rester ?",
				paragraphs: ["Trois nuits constituent le format idéal d'un city-break : une journée antique, une journée Vatican, une journée centre baroque et Trastevere. Quatre à cinq nuits permettent d'ajouter la galerie Borghèse, la Via Appia à vélo et les catacombes.", "Pour une semaine, Rome sert de base à des excursions faciles en train : Ostie antique en 40 minutes, Tivoli et ses villas en une heure, Naples et Pompéi en 1 h 10 de train à grande vitesse."]
			}
		]
	},
	{
		...
		description: "Guide Tunis : meilleure période, médina et Sidi Bou Saïd, budget sur place, transports, monnaie, formalités pour les Français et conseils pratiques.",
		intro: "Tunis se visite facilement en trois jours, entre la médina classée, les mosaïques du Bardo et les villages côtiers de Carthage et Sidi Bou Saïd, tous accessibles par le petit train TGM. Voici l'essentiel avant de réserver votre vol.",
		readingMinutes: 7,
		updated: "2026-08-30",
		practical: {
		...
		sections: [
			...
			{
				heading: "Combien de temps rester ?",
				paragraphs: ["Trois nuits couvrent confortablement la médina, le Bardo, Carthage et Sidi Bou Saïd. Quatre à cinq nuits permettent d'ajouter Dougga, l'un des sites romains les mieux conservés d'Afrique du Nord, à deux heures de route.", "Pour un séjour d'une semaine, Tunis se combine facilement avec Hammamet ou Sousse en train, ou avec Kairouan et El Jem pour un circuit patrimonial. Les louages (taxis collectifs interurbains) rendent ces trajets simples et très bon marché."]
			}
		]
	},
	{
		...
		description: "Guide Londres : meilleure période, quartiers où loger, budget réel sur place, métro et Oyster, livre sterling et formalités post-Brexit pour les Français.",
		intro: "Londres se visite toute l'année, mais le budget change du simple au double selon la saison et le quartier choisi. Voici les repères concrets avant de réserver : climat, quartiers, coût de la vie sur place et formalités depuis le Brexit.",
		readingMinutes: 7,
		updated: "2026-08-31",
		practical: {
		...
		sections: [
			...
			{
				heading: "Combien de temps rester ?",
				paragraphs: ["Trois nuits permettent de couvrir Westminster, la City, South Bank et deux grands musées sans courir. Quatre à cinq nuits ajoutent les quartiers de l'est, Greenwich et une soirée dans le West End.", "Au-delà d'une semaine, Londres devient une base idéale pour des excursions à la journée en train : Oxford, Cambridge, Brighton ou Windsor sont tous à moins de deux heures."]
			}
		]
	},
	{
		...
		description: "Guide Amsterdam : quand partir, quartiers où loger, budget quotidien, vélo et transports, musées à réserver et conseils pratiques pour les voyageurs français.",
		intro: "Amsterdam se parcourt à vélo ou à pied en deux ou trois jours, à condition de réserver les musées à l'avance et de bien choisir son quartier. Voici les informations utiles avant de réserver votre vol.",
		readingMinutes: 6,
		updated: "2026-08-31",
		practical: {
		...
		sections: [
			...
			{
				heading: "Combien de temps rester ?",
				paragraphs: ["Deux à trois nuits suffisent largement pour les canaux, deux grands musées et un quartier hors centre comme De Pijp ou Noord.", "Avec quatre ou cinq nuits, ajoutez une journée à Haarlem, Utrecht ou Rotterdam, toutes à moins d'une heure de train, ou le parc floral du Keukenhof entre mi-mars et mi-mai."]
			}
		]
	},
	{
		...
		description: "Guide Milan : meilleure période, quartiers à voir, budget sur place, métro et aéroports, réservation de la Cène et conseils pratiques pour les Français.",
		intro: "Milan se visite très bien en deux ou trois jours et sert de porte d'entrée idéale vers les lacs italiens. Voici ce qu'il faut savoir avant de réserver : saison, quartiers, budget réel et transports depuis les trois aéroports.",
		readingMinutes: 6,
		updated: "2026-08-31",
		practical: {
		...
		sections: [
			...
			{
				heading: "Combien de temps rester ?",
				paragraphs: ["Deux nuits suffisent pour le Duomo, Brera, les Navigli et un musée. Trois à quatre nuits permettent d'ajouter la Cène, le château des Sforza et une journée sur un lac.", "Pour une semaine, Milan se combine facilement avec Turin, Vérone ou Venise, toutes accessibles en train à grande vitesse en 1 à 2 h 30."]
			}
		]
	},
	{
		...
		description: "Guide Berlin : quand partir, quartiers où loger, budget quotidien, U-Bahn et S-Bahn, musées à réserver et conseils pratiques pour les voyageurs français.",
		intro: "Berlin est une capitale étendue où tout se joue sur le choix du quartier et la maîtrise du réseau U-Bahn / S-Bahn. Voici les repères concrets avant de réserver : saison, quartiers, budget réel et formalités.",
		readingMinutes: 7,
		updated: "2026-08-31",
		practical: {
		...
		sections: [
			...
			{
				heading: "Combien de temps rester ?",
				paragraphs: ["Trois nuits sont un bon minimum pour Mitte, l'Île aux Musées, l'East Side Gallery et un quartier alternatif.", "Quatre à cinq nuits permettent d'ajouter Potsdam et le château de Sanssouci (30 minutes de S-Bahn), le mémorial de Sachsenhausen ou une journée dans les lacs du Wannsee."]
			}
		]
	},
	{
		...
		description: "Guide Athènes : meilleure période, quartiers à voir, budget sur place, métro et ferries vers les îles, billet combiné Acropole et conseils pour les Français.",
		intro: "Athènes se visite en deux ou trois jours et sert de point de départ vers les îles. Voici les informations concrètes à connaître : quelle saison éviter, où loger, quel budget prévoir et comment enchaîner avec une île.",
		readingMinutes: 7,
		updated: "2026-08-31",
		practical: {
		...
		sections: [
			...
			{
				heading: "Combien de temps rester ?",
				paragraphs: ["Deux nuits couvrent l'Acropole, son musée, l'Agora antique et Plaka. Trois à quatre nuits ajoutent le cap Sounion, le monastère de Dafni ou une journée de plage sur la riviera athénienne.", "Pour une semaine, combinez Athènes avec une ou deux îles proches accessibles en ferry rapide : Égine, Hydra et Poros sont à moins de deux heures du Pirée."]
			}
		]
	},
	{
		...
		description: "Guide Vienne : meilleure période, quartiers à voir, budget sur place, U-Bahn, cafés historiques, opéra et conseils pratiques pour les voyageurs français.",
		intro: "Vienne est une capitale compacte, très bien desservie et étonnamment abordable une fois sur place. Voici les repères utiles avant de réserver : saison, quartiers, budget réel et bons réflexes pour l'opéra et les musées.",
		readingMinutes: 6,
		updated: "2026-08-31",
		practical: {
		...
		sections: [
			...
			{
				heading: "Combien de temps rester ?",
				paragraphs: ["Trois nuits permettent de voir le centre, deux grands musées, Schönbrunn et le Belvédère sans se presser.", "Quatre à cinq nuits ouvrent la porte à une journée à Bratislava (1 heure de train), dans la vallée de la Wachau ou à Melk et son abbaye baroque."]
			}
		]
	},
	{
		...
		description: "Guide Prague : quand partir, quartiers à voir, budget sur place, couronne tchèque, tramways, pièges à touristes à éviter et conseils pour les Français.",
		intro: "Prague se parcourt à pied et reste l'une des capitales les moins chères d'Europe, à condition d'éviter quelques pièges classiques sur le change et les restaurants du centre. Voici l'essentiel avant de réserver.",
		readingMinutes: 6,
		updated: "2026-08-31",
		practical: {
		...
		sections: [
			...
			{
				heading: "Combien de temps rester ?",
				paragraphs: ["Trois nuits suffisent pour la vieille ville, le château, Josefov et une soirée dans un quartier local.", "Quatre à cinq nuits permettent d'ajouter Kutná Hora et son ossuaire, le château de Karlštejn ou Český Krumlov, à trois heures de bus au sud."]
			}
		]
	},
	{
		...
		description: "Guide Séville : meilleure période, quartiers à voir, budget sur place, Alcazar à réserver, tapas, flamenco et conseils pratiques pour les voyageurs français.",
		intro: "Séville se visite à pied, mais tout dépend de la saison : l'été andalou dépasse régulièrement 40 °C. Voici les informations concrètes avant de réserver votre vol : quand partir, où loger et quel budget prévoir.",
		readingMinutes: 6,
		updated: "2026-08-31",
		practical: {
		...
		sections: [
			...
			{
				heading: "Combien de temps rester ?",
				paragraphs: ["Trois nuits couvrent l'Alcázar, la cathédrale, Santa Cruz, Triana et une soirée flamenco.", "Quatre à cinq nuits permettent d'ajouter Cordoue (45 minutes en train à grande vitesse), Cadix ou Jerez. Une semaine autorise une boucle andalouse complète avec Grenade."]
			}
		]
	},
	{
		...
		description: "Guide Copenhague : quand partir, quartiers à voir, budget réel sur place, couronne danoise, vélo et métro, et conseils pratiques pour les voyageurs français.",
		intro: "Copenhague est compacte, entièrement cyclable et l'une des capitales les plus chères d'Europe : bien préparer son budget change tout. Voici les repères concrets avant de réserver votre vol.",
		readingMinutes: 6,
		updated: "2026-08-31",
		practical: {
		...
		sections: [
			...
			{
				heading: "Combien de temps rester ?",
				paragraphs: ["Deux à trois nuits suffisent pour le centre, Christianshavn, un musée et une soirée à Nørrebro ou Vesterbro.", "Quatre nuits permettent d'ajouter le musée d'art moderne Louisiana au bord du Sund, le château de Kronborg à Helsingør, ou une journée à Malmö en Suède, à 35 minutes de train."]
			}
		]
	},
	{
		...
		description: "Guide Madrid : meilleure période, quartiers où loger, budget réel sur place, musées gratuits et accès depuis l'aéroport pour les voyageurs français.",
		intro: "Madrid se visite toute l'année, mais la chaleur de juillet-août change radicalement l'expérience. Voici les repères concrets avant de réserver : climat, quartiers, budget réel et accès depuis Barajas.",
		readingMinutes: 6,
		updated: "2026-08-31",
		practical: {
			monnaie: "Euro (EUR).",
		...
		sections: [
			...
			{
				heading: "Combien de temps rester ?",
				paragraphs: ["Trois nuits couvrent le centre historique, le triangle de l'art et un quartier plus local comme Malasaña ou La Latina.", "Cinq nuits laissent le temps d'ajouter une excursion à la journée : Tolède ou Ségovie sont à moins d'une heure en train à grande vitesse."]
			}
		]
	},
	{
		...
		description: "Guide Dublin : meilleure période, quartiers où loger, budget réel sur place, accès depuis l'aéroport et formalités pour les voyageurs français.",
		intro: "Dublin se visite toute l'année sous un climat changeant, mais le budget sur place varie moins selon la saison que dans la plupart des capitales : c'est une ville chère toute l'année. Voici les repères concrets avant de réserver.",
		readingMinutes: 6,
		updated: "2026-08-31",
		practical: {
			monnaie: "Euro (EUR).",
		...
		sections: [
			...
			{
				heading: "Combien de temps rester ?",
				paragraphs: ["Deux à trois nuits suffisent pour le centre historique, Temple Bar, Trinity College et un musée.", "Quatre à cinq nuits permettent d'ajouter une excursion à la journée vers les falaises de Howth, le comté de Wicklow, ou une location de voiture vers la côte ouest et la Chaussée des Géants (plus loin, à prévoir sur plusieurs jours)."]
			}
		]
	},
	{
		...
		description: "Guide Munich : meilleure période, quartiers où loger, budget réel sur place, Oktoberfest et accès depuis l'aéroport pour les voyageurs français.",
		intro: "Munich se visite agréablement une bonne partie de l'année, mais un seul événement bouleverse le calendrier des prix : l'Oktoberfest. Voici les repères concrets avant de réserver, que vous visiez la fête ou que vous préfériez l'éviter.",
		readingMinutes: 6,
		updated: "2026-08-31",
		practical: {
			monnaie: "Euro (EUR).",
		...
		sections: [
			...
			{
				heading: "Combien de temps rester ?",
				paragraphs: ["Deux à trois nuits couvrent l'Altstadt, l'Englischer Garten et un musée (la Pinacothèque ou le Deutsches Museum).", "Quatre nuits ou plus permettent une excursion à la journée vers le château de Neuschwanstein ou les Alpes bavaroises, à environ deux heures de train."]
			}
		]
	},
	{
		...
		description: "Guide Porto : meilleure période, quartiers où loger, budget réel sur place, caves de vin de Porto et accès depuis l'aéroport pour les voyageurs français.",
		intro: "Porto reste l'une des capitales les plus abordables d'Europe de l'Ouest, avec un climat plus doux que Lisbonne l'été et un accès aéroport particulièrement simple. Voici les repères concrets avant de réserver.",
		readingMinutes: 6,
		updated: "2026-08-31",
		practical: {
			monnaie: "Euro (EUR).",
		...
		sections: [
			...
			{
				heading: "Combien de temps rester ?",
				paragraphs: ["Deux à trois nuits couvrent la Ribeira, Vila Nova de Gaia et une visite de cave.", "Quatre à cinq nuits permettent une excursion à la journée vers la vallée du Douro (vignobles en terrasses) ou vers Braga et Guimarães, toutes deux à moins d'une heure de train."]
			}
		]
	},
	{
		...
		description: "Guide Budapest : meilleure période, quartiers où loger, budget réel sur place, bains thermaux et accès depuis l'aéroport pour les voyageurs français.",
		intro: "Budapest reste l'une des capitales les moins chères d'Europe, avec un patrimoine architectural dense des deux côtés du Danube. Voici les repères concrets avant de réserver : climat, quartiers, budget réel et devise locale.",
		readingMinutes: 6,
		updated: "2026-08-31",
		practical: {
		...
		sections: [
			...
			{
				heading: "Combien de temps rester ?",
				paragraphs: ["Trois nuits couvrent Buda, Pest, une session de bains thermaux et le quartier juif.", "Quatre à cinq nuits permettent d'ajouter une croisière sur le Danube au coucher du soleil ou une excursion à la journée vers le lac Balaton ou la ville de Szentendre."]
			}
		]
	},
	{
		...
		description: "Guide Séoul : meilleure période, quartiers à voir, budget réel sur place, K-ETA et accès depuis l'aéroport d'Incheon pour les voyageurs français.",
		intro: "Séoul mélange palais historiques et modernité vertigineuse, avec un budget sur place étonnamment raisonnable pour une capitale asiatique. Voici les repères concrets avant de réserver : climat, quartiers, formalités et budget réel.",
		readingMinutes: 6,
		updated: "2026-08-31",
		practical: {
		...
		sections: [
			...
			{
				heading: "Combien de temps rester ?",
				paragraphs: ["Trois à quatre nuits couvrent les palais, Bukchon, Myeongdong et Gangnam sans courir.", "Une semaine permet d'ajouter une excursion à la zone démilitarisée (DMZ) ou un aller-retour à Busan en train à grande vitesse (environ 2 h 30)."]
			}
		]
	},
	{
		...
		description: "Guide Hong Kong : meilleure période, quartiers à voir, budget réel sur place, accès depuis l'aéroport et formalités pour les voyageurs français.",
		intro: "Hong Kong compresse gratte-ciels, marchés traditionnels et nature environnante sur un territoire réduit, avec l'un des réseaux de transport les plus efficaces d'Asie. Voici les repères concrets avant de réserver.",
		readingMinutes: 6,
		updated: "2026-08-31",
		practical: {
		...
		sections: [
			...
			{
				heading: "Combien de temps rester ?",
				paragraphs: ["Trois nuits couvrent Central, Victoria Peak, Tsim Sha Tsui et un marché nocturne.", "Quatre à cinq nuits permettent d'ajouter une randonnée, une île extérieure (Lamma ou Cheung Chau) ou une excursion à Macao, à environ une heure de ferry."]
			}
		]
	},
	{
		...
		description: "Guide Montréal : meilleure période, quartiers à voir, budget réel sur place, accès depuis l'aéroport et formalités pour les voyageurs français.",
		intro: "Montréal offre un dépaysement nord-américain à seulement sept heures et demie de vol, sans barrière de langue. Le climat change radicalement selon la saison : voici les repères concrets avant de réserver.",
		readingMinutes: 6,
		updated: "2026-08-31",
		practical: {
		...
		sections: [
			...
			{
				heading: "Combien de temps rester ?",
				paragraphs: ["Trois nuits couvrent le Vieux-Montréal, le Plateau et le Mont-Royal.", "Cinq nuits ou plus permettent une excursion à Québec (environ 3 h de route ou de train) ou dans les Laurentides pour la nature environnante."]
			}
		]
	},
	{
		...
		description: "Guide Los Angeles : meilleure période, quartiers à voir, budget réel sur place, ESTA et déplacements pour les voyageurs français.",
		intro: "Los Angeles s'étend sur une surface immense, ce qui change fondamentalement la façon d'organiser un séjour par rapport à une capitale européenne compacte. Voici les repères concrets avant de réserver : climat, quartiers, déplacements et budget réel.",
		readingMinutes: 6,
		updated: "2026-08-31",
		practical: {
		...
		sections: [
			...
			{
				heading: "Combien de temps rester ?",
				paragraphs: ["Quatre nuits permettent de couvrir Santa Monica, Hollywood et Downtown sans excès de route chaque jour.", "Une semaine ou plus laisse le temps d'ajouter une excursion à San Diego ou dans le désert (Joshua Tree, Palm Springs), à deux à trois heures de route."]
			}
		]
	},
	{
		...
		description: "Guide Le Caire : meilleure période, pyramides de Gizeh, budget réel sur place, visa et conseils pratiques pour les voyageurs français.",
		intro: "Le Caire est l'une des destinations dépaysantes les plus rapides à atteindre depuis Paris, à quatre heures et demie de vol. La chaleur estivale extrême pousse la plupart des visiteurs vers l'automne, l'hiver ou le printemps. Voici les repères concrets avant de réserver.",
		readingMinutes: 6,
		updated: "2026-08-31",
		practical: {
		...
		sections: [
			...
			{
				heading: "Combien de temps rester ?",
				paragraphs: ["Trois nuits suffisent pour les pyramides, le musée égyptien et Le Caire islamique.", "Cinq nuits ou plus permettent d'ajouter une extension vers Louxor et la vallée des Rois, généralement en vol intérieur court depuis Le Caire."]
			}
		]
	},
	{
		...
		description: "Guide Dakar : meilleure période, île de Gorée, budget réel sur place, formalités et accès depuis l'aéroport pour les voyageurs français.",
		intro: "Dakar mélange front de mer atlantique, marchés animés et un passé historique dense, à moins de six heures de vol de Paris. Voici les repères concrets avant de réserver : climat, incontournables et budget réel.",
		readingMinutes: 6,
		updated: "2026-08-31",
		practical: {
		...
		sections: [
			...
			{
				heading: "Combien de temps rester ?",
				paragraphs: ["Trois nuits couvrent Dakar, l'île de Gorée et les Almadies.", "Cinq nuits ou plus permettent une extension vers la Petite Côte (Saly, Toubab Dialaw) ou le lac Rose, à une à deux heures de route de la capitale."]
			}
		]
	},
	{
		...
		description: "Guide Reykjavik : meilleure période, Cercle d'or, aurores boréales, budget réel sur place pour les voyageurs français.",
		intro: "Reykjavik sert de base idéale pour explorer les paysages islandais, entre geysers, chutes d'eau et côtes volcaniques. Voici les repères concrets avant de réserver : quand partir, que voir et combien prévoir, dans un pays réputé cher.",
		readingMinutes: 6,
		updated: "2026-08-31",
		practical: {
		...
		sections: [
			...
			{
				heading: "Combien de temps rester ?",
				paragraphs: ["Trois à quatre nuits permettent Reykjavik, le Cercle d'or et le Blue Lagoon.", "Une semaine ou plus laisse le temps d'explorer la côte sud (plages de sable noir, glaciers) ou de faire une partie du tour de l'île par la route 1."]
			}
		]
	},
	{
		...
		description: "Guide Stockholm : meilleure période, quartiers à voir, budget réel sur place, accès depuis Arlanda pour les voyageurs français.",
		intro: "Stockholm, bâtie sur quatorze îles reliées par des ponts, se visite dans des conditions radicalement différentes selon la saison. Voici les repères concrets avant de réserver : climat, quartiers, budget réel et accès depuis l'aéroport.",
		readingMinutes: 6,
		updated: "2026-08-31",
		practical: {
		...
		sections: [
			...
			{
				heading: "Combien de temps rester ?",
				paragraphs: ["Trois nuits couvrent Gamla Stan, Södermalm et Djurgården.", "Quatre à cinq nuits permettent d'ajouter une excursion dans l'archipel de Stockholm (plus de 30 000 îles et îlots) en bateau depuis le centre."]
			}
		]
	},
	{
		...
		description: "Guide Mexico : meilleure période, quartiers à voir, budget réel sur place, altitude et conseils pratiques pour les voyageurs français.",
		intro: "Mexico, perchée à plus de 2 200 mètres d'altitude, profite d'un climat tempéré toute l'année, loin de l'image tropicale qu'on prête souvent au pays. Voici les repères concrets avant de réserver : quartiers, budget réel et organisation sur place.",
		readingMinutes: 6,
		updated: "2026-08-31",
		practical: {
		...
		sections: [
			...
			{
				heading: "Combien de temps rester ?",
				paragraphs: ["Quatre nuits couvrent le Centro Histórico, Roma-Condesa et Coyoacán.", "Une semaine ou plus permet d'ajouter une excursion aux pyramides de Teotihuacán (moins d'une heure de route) ou à Puebla, ville coloniale à deux heures de route."]
			}
		]
	},
	{
		...
		description: "Guide Doha : meilleure période, souk Waqif, budget réel sur place, accès depuis l'aéroport pour les voyageurs français.",
		intro: "Doha combine gratte-ciels futuristes, souk traditionnel et musées de premier plan, à six heures et demie de vol de Paris. Voici les repères concrets avant de réserver, que ce soit pour un séjour dédié ou une escale prolongée.",
		readingMinutes: 6,
		updated: "2026-08-31",
		practical: {
		...
		sections: [
			...
			{
				heading: "Combien de temps rester ?",
				paragraphs: ["Deux à trois nuits suffisent pour le souk Waqif, le Museum of Islamic Art et la Corniche.", "Utile aussi en escale longue vers l'Asie ou l'Océanie : une journée complète permet déjà de découvrir l'essentiel de la ville."]
			}
		]
	},
	{
		...
		description: "Guide Bali : meilleure saison, quartiers Ubud, Seminyak et Canggu, budget sur place, transports, visa et conseils pratiques pour les voyageurs français.",
		intro: "Bali ne se limite pas à une plage : l'île concentre rizières en terrasses, temples, spots de surf et scène de travailleurs à distance, à condition de bien choisir sa base tant les ambiances diffèrent d'un quartier à l'autre. Voici les repères concrets avant de réserver.",
		readingMinutes: 8,
		updated: "2026-09-01",
		practical: {
		...
		sections: [
			...
			{
				heading: "Combien de temps rester ?",
				paragraphs: ["Une semaine permet de combiner deux bases — par exemple Ubud pour la culture et les rizières, puis Uluwatu ou Seminyak pour la plage — plutôt que de tout faire depuis un seul point de chute vu les distances et le trafic.", "Compte tenu du trajet (17 à 20 heures avec escale), un séjour de moins de dix jours rentabilise mal le temps de vol : la plupart des voyageurs venus d'Europe restent deux à trois semaines, parfois en combinant Bali avec les îles voisines de Nusa Penida ou Gili."]
			}
		]
	},
	{
		...
		description: "Guide Casablanca : meilleure période, mosquée Hassan II, budget réel sur place, accès depuis l'aéroport pour les voyageurs français.",
		intro: "Casablanca, capitale économique du Maroc, contraste avec l'image touristique de Marrakech : architecture Art déco, corniche atlantique et rythme de grande ville active. Voici les repères concrets avant de réserver.",
		readingMinutes: 6,
		updated: "2026-09-01",
		practical: {
		...
		sections: [
			...
			{
				heading: "Combien de temps rester ?",
				paragraphs: ["Deux nuits suffisent pour la mosquée Hassan II, la médina et la Corniche.", "Casablanca fonctionne aussi très bien comme point de passage : beaucoup de voyageurs y font escale une nuit avant de rejoindre Marrakech, Rabat (moins d'une heure de train) ou Essaouira."]
			}
		]
	},
	{
		...
		description: "Guide Miami : meilleure période, quartiers à voir, budget réel sur place, ESTA et conseils pratiques pour les voyageurs français.",
		intro: "Miami mélange plages Art déco, culture latino-américaine et vie nocturne, à neuf heures et demie de vol de Paris. Voici les repères concrets avant de réserver : climat, quartiers, budget réel et organisation sur place.",
		readingMinutes: 6,
		updated: "2026-09-01",
		practical: {
			monnaie: "Dollar américain (USD).",
		...
		sections: [
			...
			{
				heading: "Combien de temps rester ?",
				paragraphs: ["Quatre nuits permettent de couvrir South Beach, Wynwood et Little Havana sans excès de route chaque jour.", "Une semaine ou plus laisse le temps d'ajouter une excursion aux Keys (Key West, à environ trois heures de route) ou aux Everglades."]
			}
		]
	}
];
function getCityGuide(slug) {
	return CITY_GUIDES.find((guide) => guide.slug === slug);
}
/** Guide correspondant à une page trajet (/vols/<routeSlug>). */
function getCityGuideForRoute(routeSlug) {
...
*/
function guideForRoutePage(routeSlug, destination) {
	const code = destination.toUpperCase();
	return CITY_GUIDES.find((guide) => guide.destination.toUpperCase() === code) ?? getCityGuideForRoute(routeSlug);
}
//#endregion
export { guideForRoutePage as i, city_guides_exports as n, getCityGuide as r, CITY_GUIDES as t };
